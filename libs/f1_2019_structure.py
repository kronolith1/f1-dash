...
class CarMotionData(ctypes.LittleEndianStructure):
    ...
    _fields_ = [
        ...
        ('m_worldForwardDirX', ctypes.c_uint16),
        ('m_worldForwardDirY', ctypes.c_uint16),
        ('m_worldForwardDirZ', ctypes.c_uint16),
...
class PacketSessionData(ctypes.LittleEndianStructure):
    ...
    _fields_ = [
        ...
        ('m_formula', ctypes.c_uint8),  # Era, 0 = modern, 1 = classic
...
class ParticipantData(ctypes.LittleEndianStructure):
    ...
    _fields_ = [
        ...
        ('m_yourTelemetry', ctypes.c_uint8)  # Name of participant in UTF-8 format – null terminated
